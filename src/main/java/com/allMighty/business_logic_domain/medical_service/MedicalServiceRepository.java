...
public class MedicalServiceRepository {
    ...
    private final MedicalServiceMapper.MedicalServiceJooqMapper medicalServiceJooqMapper = new MedicalServiceMapper.MedicalServiceJooqMapper();
    ...
    public Optional<MedicalServiceEntity> findById(Long id) {
        ...
        List<MedicalServiceEntity> medicalServices = getAllMedicalServices(Collections.singletonList(eq), null);
