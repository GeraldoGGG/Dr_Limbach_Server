...
public class ResponseFactory {
  public static <T> EntityPageResponseDTO<T> createPage(
      Long count, List<T> items, PageDescriptor pageDescriptor) {
  ...
  public static DeleteDTO createDeleteResponse(Long id) {
